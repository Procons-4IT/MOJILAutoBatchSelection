                    ...
                    Case False
                        Select Case pVal.EventType
                            Case SAPbouiCOM.BoEventTypes.et_FORM_LOAD
                                oForm = oApplication.SBO_Application.Forms.Item(FormUID)
                                oApplication.Utilities.AddControls(oForm, "_14", "25", SAPbouiCOM.BoFormItemTypes.it_STATIC, "DOWN", , , , "Item Type")
                                oApplication.Utilities.AddControls(oForm, "_15", "24", SAPbouiCOM.BoFormItemTypes.it_EDIT, "DOWN", , , , )
                                oEditText = oForm.Items.Item("_15").Specific
                                oEditText.DataBind.SetBound(True, "OITM", "U_Z_ItemType")
                                AddChooseFromList(oForm)
                                oEditText.ChooseFromListUID = "CFL10"
                                oEditText.ChooseFromListAlias = "U_ItemType"
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        oForm.Freeze(True)
                                        If pVal.ItemUID = "_15" Then
                                            oApplication.Utilities.setEdittextvalue(oForm, "_15", oDataTable.GetValue("U_ItemType", 0))
                                        End If
                                        oForm.Update()
                                        oForm.Freeze(False)
                                    End If
